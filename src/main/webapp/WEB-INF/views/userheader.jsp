 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
       <a class="navbar-brand" href="#" style="color : #000080;">RGS</a>
		...
		<a class="nav-link" href="<c:url value='/user/userhome'/>">Home</a>
        <a class="nav-link" href="<c:url value='/doctors/searchdoctorpage'/>">Book Appointment</a>        
        <a class="nav-link" href="<c:url value='/appointment/displayappointmentbypatient'/>">Appointment</a>
        <a class="nav-link" href="<c:url value='/transaction/transactionpatient'/>">Transaction</a>       	
        </div>
        <a class="nav-link logout-link" href="<c:url value='/user/viewprofile'/>">Profile</a>
