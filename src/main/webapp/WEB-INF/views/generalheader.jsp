<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="navbar-nav me-auto">
            <a class="nav-link" href="<c:url value='/user/generalhome'/>">Home</a>
            <a class="nav-link" href="<c:url value='/user/generalabout'/>">About</a>
            <a class="nav-link" href ="<c:url value='/user/generalcontact'/>">Contact Us</a>
        </div>
        <a class="nav-link logout-link" href="<c:url value='/loginpage/login'/>">Login</a>
        <a class="nav-link logout-link" href="<c:url value='/user/add'/>">Register</a>    
